...
define('compareList',['jquery','bootstrap','purl','db'], function () {
	var COMPARELIST = {
...
define('compareTable',['jquery','bootstrap','purl','db', 'compareList'], function () {
...
define('analysis',['jquery','bootstrap','purl','db', 'compareList', 'compareTable'], function () {
...
define("lazyload", ["jquery"], (function (global) {
    return function () {
        var ret, fn;
